...
namespace Simulation.Services.ICD.Factories
{
    public class TelemetryICDItemFactory : IICDItemFactory
    {
        ...
        public ICDItem CreateItem(TelemetryFields field, int bitOffset, int bitLength)
        {
            return field switch
            {
                TelemetryFields.DragCoefficient or TelemetryFields.LiftCoefficient =>
                    CreateCoefficientItem(field, bitOffset, bitLength),
                TelemetryFields.ThrottlePercent or TelemetryFields.FuelAmount =>
                    CreatePercentageItem(field, bitOffset, bitLength),
                TelemetryFields.CruiseAltitude or TelemetryFields.Altitude => CreateAltitudeItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                ...
                TelemetryFields.LandingGearStatus => CreateLandingGearItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                ...
                TelemetryFields.PitchDeg or TelemetryFields.RollDeg => CreateOffsetAngleItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                TelemetryFields.ThrustAfterInfluence => CreateThrustItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                TelemetryFields.DataStorageUsedGB => CreateDataStorageItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                TelemetryFields.FlightTimeSec => CreateTimeItem(field, bitOffset, bitLength),
                TelemetryFields.SignalStrength => CreateSignalStrengthItem(
                    field,
                    bitOffset,
                    bitLength
                ),
                TelemetryFields.Rpm => CreateRpmItem(field, bitOffset, bitLength),
                TelemetryFields.EngineDegrees => CreateEngineDegreesItem(
                    field,
                    bitOffset,
                    bitLength
                ),
        ...
        private ICDItem CreateSignalStrengthItem(
        ...
        private static double GenerateRandomValue(double minValue, double maxValue)
        {
            if (
                ...
                < SimulationConstants.TelemetryCompression.EPSILON_COMPARISON
            )
                return minValue;
