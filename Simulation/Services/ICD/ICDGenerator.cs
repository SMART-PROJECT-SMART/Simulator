...
namespace Simulation.Services.ICD
{
    public class ICDGenerator
    {
        ...
        private ICDItem CreateTelemetryICDItem(TelemetryFields field, int bitOffset)
        {
            return field switch
            {
                TelemetryFields.DragCoefficient => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                ...
                TelemetryFields.LiftCoefficient => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.DEFAULT_VALUE,
                ...
                TelemetryFields.Latitude => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                ...
                TelemetryFields.Longitude => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                ...
                TelemetryFields.YawDeg => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.DEFAULT_VALUE,
                ...
                TelemetryFields.PitchDeg => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                ...
                TelemetryFields.RollDeg => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.ANGLE_HALF_ROTATION_NEGATIVE,
                ...
                TelemetryFields.ThrustAfterInfluence => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.DEFAULT_VALUE,
                ...
                TelemetryFields.DataStorageUsedGB => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.DEFAULT_VALUE,
                ...
                TelemetryFields.SignalStrength => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                ...
                TelemetryFields.EngineDegrees => new ICDItem(
                    field,
                    typeof(double),
                    GenerateRandomValue(
                        SimulationConstants.ICDGeneration.DEFAULT_VALUE,
