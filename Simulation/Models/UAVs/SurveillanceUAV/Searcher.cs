...
namespace Simulation.Models.UAVs.SurveillanceUAV
{
    public class Searcher : SurveillanceUAV
    {
        ...
        ) : base(startLocation, tailId)
        {
            ...
            TelemetryData[TelemetryFields.FrontalSurface] = SimulationConstants.Searcher_Constants.FrontalSurface;
            TelemetryData[TelemetryFields.WingsSurface] = SimulationConstants.Searcher_Constants.WingsSurface;
            ...
            TelemetryData[TelemetryFields.ThrustMax] = SimulationConstants.Searcher_Constants.ThrustMax;
            TelemetryData[TelemetryFields.MaxCruiseSpeedKmph] = SimulationConstants.Searcher_Constants.MaxCruiseSpeedKmph;
            TelemetryData[TelemetryFields.MaxAccelerationMps2] = SimulationConstants.Searcher_Constants.MaxAcceleration;
            TelemetryData[TelemetryFields.MaxDecelerationMps2] = SimulationConstants.Searcher_Constants.MaxDeceleration;
            ...
            TelemetryData[TelemetryFields.DataStorageCapacityGB] = SimulationConstants.Searcher_Constants.DataStorageCapacityGB;
