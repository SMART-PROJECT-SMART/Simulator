...
namespace Simulation.Models.UAVs.SurveillanceUAV
{
    public class Hermes450 : SurveillanceUAV
    {
        ...
        ) : base(startLocation, tailId)
        {
            ...
            TelemetryData[TelemetryFields.FrontalSurface] = SimulationConstants.Hermes450_Constants.FrontalSurface;
            TelemetryData[TelemetryFields.WingsSurface] = SimulationConstants.Hermes450_Constants.WingsSurface;
            ...
            TelemetryData[TelemetryFields.ThrustMax] = SimulationConstants.Hermes450_Constants.ThrustMax;
            TelemetryData[TelemetryFields.MaxCruiseSpeedKmph] = SimulationConstants.Hermes450_Constants.MaxCruiseSpeedKmph;
            TelemetryData[TelemetryFields.MaxAccelerationMps2] = SimulationConstants.Hermes450_Constants.MaxAcceleration;
            TelemetryData[TelemetryFields.MaxDecelerationMps2] = SimulationConstants.Hermes450_Constants.MaxDeceleration;
            ...
            TelemetryData[TelemetryFields.DataStorageCapacityGB] = SimulationConstants.Hermes450_Constants.DataStorageCapacityGB;
